...
Under linux in some python versions there seems to be a problem with pip which is descibed here: https://bugs.launchpad.net/ubuntu/+source/python-pip/+bug/1306991. To work around this you have to:
...
Then you can use rules to trigger this Python script via executeCommandLine on some specific time (cron expression) or via switch in UI. 
